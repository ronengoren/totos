...
class Settings extends PureComponent {
  ...
  showDialog = action => {
    ...
    if (action === "showFirstDayOfWeek") {
      ...
      dialog = generateDialogObject(translations.showLanguagesTitle, false, {
        [translations.cancel]: () => {
          this.setState({ [action]: false });
        }
      });
            ...
            >
              ...
              <SettingsList.Item
                ...
                switchOnValueChange={value =>
                  this.toggleSetting(value, "TimeFormat")
                }
              ...
              <SettingsList.Item
                ...
                hasSwitch={false}
                titleInfo={
                  daysOfWeek.find(d => d.value === settings.firstDayOfWeek).name
                }
              ...
              <SettingsList.Item
                ...
                switchOnValueChange={value =>
                  this.toggleSetting(value, "ConfirmFinishingTask")
                }
                titleStyle={{ color: theme.textColor, fontSize: 16 }}
              ...
              <SettingsList.Item
                ...
                switchOnValueChange={value =>
                  this.toggleSetting(value, "ConfirmRepeatingTask")
                }
                titleStyle={{ color: theme.textColor, fontSize: 16 }}
              ...
              <SettingsList.Item
                ...
                switchOnValueChange={value =>
                  this.toggleSetting(value, "ConfirmDeletingTask")
                }
                titleStyle={{ color: theme.textColor, fontSize: 16 }}
              ...
              <SettingsList.Item
                ...
                switchOnValueChange={value =>
                  this.toggleSetting(value, "HideTabView")
                }
                titleStyle={{ color: theme.textColor, fontSize: 16 }}
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    onChangeFirstDayOfWeek: value =>
      dispatch(actions.changeFirstDayOfWeek(value)),
    onChangeTimeFormat: value => dispatch(actions.changeTimeFormat(value)),
    onChangeConfirmRepeatingTask: value =>
      dispatch(actions.changeConfirmRepeatingTask(value)),
    onChangeConfirmFinishingTask: value =>
      dispatch(actions.changeConfirmFinishingTask(value)),
    onChangeConfirmDeletingTask: value =>
      dispatch(actions.changeConfirmDeletingTask(value)),
