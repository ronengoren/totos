...
class TaskList extends Component {
  state = {
    ...
    priorityColors: {
      none: {
        ...
        color: this.props.theme.noneTextColor
      },
      low: {
        bgColor: this.props.theme.lowColor,
        color: this.props.theme.lowTextColor
      },
      medium: {
        bgColor: this.props.theme.mediumColor,
        color: this.props.theme.mediumTextColor
      },
      high: {
        bgColor: this.props.theme.highColor,
        color: this.props.theme.highTextColor
      }
    },
    dialog: {},
    showDialog: false,
  ...
  dropdownRenderRow(rowData) {
    ...
    if (rowData.id === -3) {
      ...
      const amountOfTasks = this.props.tasks.filter(
        task => task.category === rowData.name
      );
      data = {
                    ...
                    rightElement={
                      <View style={styles.rightElements}>
                        <Button
                          ...
                          text={
                            task.finish ? translations.undo : translations.done
                          }
...
const mapDispatchToProps = dispatch => {
  return {
    onFinishTask: (task, endTask, primaryColor, callback) =>
      dispatch(actions.finishTask(task, endTask, primaryColor, callback)),
