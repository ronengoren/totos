...
export const changeTimeFormat = value => {
  return dispatch => {
    db.transaction(
      tx => {
        tx.executeSql(
          "update settings set timeFormat = ? where id = 0;",
          [value],
          () => {
            dispatch(initSettings());
          }
...
export const changeFirstDayOfWeek = value => {
  return dispatch => {
    db.transaction(
      tx => {
        tx.executeSql(
          "update settings set firstDayOfWeek = ? where id = 0;",
          [value],
          () => {
            dispatch(initSettings());
          }
...
export const changeLang = value => {
  return dispatch => {
    db.transaction(
      tx => {
        tx.executeSql(
          "update settings set lang = ? where id = 0;",
          [value],
          () => {
            dispatch(initSettings());
          }
...
export const changeConfirmFinishingTask = value => {
  return dispatch => {
    db.transaction(
      tx => {
        tx.executeSql(
          "update settings set confirmFinishingTask = ? where id = 0;",
          [value],
          () => {
            dispatch(initSettings());
          }
...
export const changeConfirmRepeatingTask = value => {
  return dispatch => {
    db.transaction(
      tx => {
        tx.executeSql(
          "update settings set confirmRepeatingTask = ? where id = 0;",
          [value],
          () => {
            dispatch(initSettings());
          }
...
export const changeConfirmDeletingTask = value => {
  return dispatch => {
    db.transaction(
      tx => {
        tx.executeSql(
          "update settings set confirmDeletingTask = ? where id = 0;",
          [value],
          () => {
            dispatch(initSettings());
          }
...
export const changeHideTabView = value => {
  return dispatch => {
    db.transaction(
      tx => {
        tx.executeSql(
          "update settings set hideTabView = ? where id = 0;",
          [value],
          () => {
            dispatch(initSettings());
          }
